...
def citest(
    ...
    * H1: x and y are conditionally dependent given z
    ...
    if statistic_args is None and statistic != "codec3":
        statistic_args = {"k": 5}
    ...
    if statistic == "codec3" and not codec_hyp:
        ...
        pval = tester.test(
            test_args["n_trials"],
            subsample_size=test_args["subsample_size"],
...
def itest(
    ...
    * H1: x and y are dependent
    ...
    if statistic_args is None and statistic != "codec2":
        statistic_args = {"k": 5}

    default_test_args = {"n_trials": 1000, "subsample_size": None, "n_jobs": 1}
