    ...
    def run(self):
        ...
        while True:
            ...
            if (
                ...
                try:
                    with open(download_path, "wb") as writefile:
                    ...
                    img["MyCuration"] = 1
                    img.to_frame().T.to_csv(
                        outcsvname,
                        sep=",",
                        mode="a",
                        index=False,
                        header=not os.path.exists(outcsvname),
                    )
...
if __name__ == "__main__":
    ...
    for pid, name in namesdf.iterrows():
        ...
        while not queue.empty():
            print(
                "queue not empty, probably finishing up for ",
                person_name,
                ": ",
                tmp,
                "secs, queue size: ",
        ...
        print(f"Finished person: {person_name}")
